...
if __name__ == '__main__':
	...
	args.id = 2 # override whatever user's input since we only be experimenting with dataset #2 here...
        n_features = 200
	...
	if args.plotsvd == True:
		...
		pl.legend()
		pl.title('SVD of Dataset#2 dataset')
		pl.show()
        ...
        classifiers = (None, MySGDClassifier, MySGDClassifier, SVR)
